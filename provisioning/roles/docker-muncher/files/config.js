...
c.containerit.baseImage = env.MUNCHER_CONTAINERIT_BASE_IMAGE || 'rocker/geospatial:4.0.5'; // when changing this, also update the "test warming" Dockerfile at ./test/Dockerfile
